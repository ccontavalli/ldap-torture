...
sub enable() {
  ...
  Torture::RBC::Check::Value($name);
  Torture::RBC::Check::Value($operations{$name});
...
sub register() {
  ...
  Torture::RBC::Check::Value($name);
  Torture::RBC::Check::Function($oper);
...
sub new() {
  ...
  Torture::RBC::Check::Class('Torture::Random.*', $random);
  Torture::RBC::Check::Class('Torture::RBC::Checker.*', $checker);
